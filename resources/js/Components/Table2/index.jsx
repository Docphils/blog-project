                    ...
                    <Box className="-mb-2 py-4 flex flex-row w-full flex-nowrap justify-between">
                        ...
                        <Box className="flex tableAddNewEntry justify-self-end items-center py-2">
                            <Link
                                ...
                                className="inline-block link px-5 py-3 min-w-fit whitespace-nowrap border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-blue-950 hover:bg-indigo-500 focus:outline-none focus:shadow-outline"
                            >
                                New Entry
                            </Link>
                        </Box>
