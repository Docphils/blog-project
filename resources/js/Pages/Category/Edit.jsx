...
export default function Edit({ auth, page_data, message, ...props }) {
    ...
    const { data, setData, processing, errors, submit, progress, reset } = useForm("post", route("category.update", { id: pagedata.id }),
        {
            name: pagedata.name,
            ...
            >
                <Box className="container">
                    <Box className="flex w-full flex-col items-center justify-center">
                        <h2 className="text-2xl">Edit The Category</h2>
