...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $modelArr = getModels($path);

        // creating permision for all available model
        foreach ($modelArr as $model) {
            // $createPer =
            Permission::create(['name' => 'create_' . $model, 'description' => 'ability to create ' . $model]);
            // $updatePer =
            Permission::create(['name' => 'update_' . $model, 'description' => 'ability to edit ' . $model]);
            // $readPer =
            Permission::create(['name' => 'read_' . $model, 'description' => 'ability to view or read ' . $model]);
            // $deletePer =
            Permission::create(['name' => 'delete_' . $model, 'description' => 'ability to delete ' . $model]);
        };
