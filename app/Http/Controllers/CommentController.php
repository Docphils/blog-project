...
class CommentController extends Controller
{
    ...
    public function __construct($model = Comment::class){
    ...
    public function show(Request $request, $id)
    {
        ...
        $data = forward_static_call([$this->model, "where"], ["id" => $id])->with(['user', 'replies', 'replies.user', 'post.user','post.comments','post.comments.user', 'post.comments.replies', 'post.comments.replies.user', 'post.category', 'post.category.subcategorys','post.subcategory', 'post.subcategory.posts'])->first();
